...
On July 2nd, 20210 the Nebraska dashboard was no longer accessible. Their Health Department website had a message stating that “The State of Nebraska COVID-19 Dashboard is no longer available as of June 30, 2021. Any future updates regarding coronavirus will be provided through new releases and through other means.” On July 20th, 2021 two new resources for vaccine information for the state of Nebraska were found. The first, provided by the state of Nebraska Health Department in response to a query submitted about accessibility of data, only updates state-level information on a weekly basis. The second resource allowed for the addition of county-level total dose information to be recorded. Beginning July 23rd, 2021 these resources were implemented into data entry and dose information began to be recorded again. Data from June 30-July 22, 2021 was copied down until the new resources were available. As of September 10th, 2021, the dashboard was found to have started reporting first dose data for certain counties, our reporting was adjusted to incorporate the reporting of this variable. The dashboard also changed from reporting total administrations for counties to second dose administration The “Doses Administered” column was no longer being updated, so we began summing the variables that were being reported to obtain the total number of doses administered for the counties.  

On 7/24/2021, “Unknown Jurisdiction” information was made available for Mississippi. Reporting was adjusted to account for any vaccination dosage that fell into this category. The added reporting for unknown jurisdictions accounts for the difference previously seen in the calculated row of state totals and what the state explicitly reports as totals on the dashboard.  

As of 8/28/2021, “Unknown Municipality” vaccination information was made available for Puerto Rico. Reporting was adjusted to start recording this dosage information. The added reporting for unknown municipalities accounts for the difference previously seen in the calculated row of state totals and what the state explicitly reports as totals on the dashboard.

On 8/28/2021, a secondary source was found for Rhode Island which reported 1st, 2nd, and total dose vaccination numbers at the county-level. Prior to this, state-level data was reported in our dataset. 
 
On 8/29/2021, the Missouri dashboard stopped reporting data for “Unknown Jurisdiction.” Following this date, the “unknown” row for Missouri has been filled in with “0” to reflect the change in dashboard reporting. 

On 8/29/2021, a secondary source was found for Oklahoma which provided “total dose” information at the county-level. Prior to this, only state-level data was reported for the state as the geographic breakdown on the state dashboard was provided by zip code only. On 9/10/2021, the secondary source updated and began reporting 1st and 2nd dose information at the county-level as well. Our data entry was adjusted accordingly, prior to these points in time, county-level reporting was inputted as a “-” to indicate no information was attainable at that geographical level.  

On 8/30/2021, it was identified that the New Hampshire dashboard had been updated to include county-level information. We adjusted our data entry and began recording 1st, 2nd, and total dose information at the county-level. Prior to this, only state-level information was available.   

As of 9/03/2021, Iowa changed their dashboard to report only county percentages for vaccinations. Data on completed (2nd) doses and total doses is available on a downloadable spreadsheet, but there exists no data for isolated 1st doses or single doses. This change impacts any data entered from 9/2 to present day.

### Additional Doses

Starting in August 2021, states began administering additional doses of the COVID-19 vaccine, specifically in those vulnerable populations and/or immunocompromised populations. In September, the FDA approved the Pfizer vaccine for additional doses and later followed with Moderna and Janssen. Slowly additional doses have been more widely reported by states. As those changes in reporting occurred, we adjusted our reporting to include the new variable. 

On August 30th, 2021, Hawaii and Missouri began reporting additional doses on their dashboards at the state-level. Once the reporting change was identified, the 3rd dose data for Hawaii and Missouri, the data was archived while our reporting was adjusted to begin incorporating that value. 

On September 8th, 2021, Kansas’ reporting began incorporating third dose totals at the state level. On October 4th, 2021, that reporting was adjusted to include county-level third dose information. As both changes in reporting were identified, our reporting was adjusted to begin incorporating that data. 
