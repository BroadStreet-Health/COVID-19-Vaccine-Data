...
<tr>
	...
	<tr>
		...
		<td><td>
 		<td><td>
		<td><td>
		<td>the total number of all administered vaccines
-3/23<td>
	</tr>
	<tr>
		<td>Florida<td>
	...
	<tr>
		<td>Georgia<td>
		<td><td>
 		<td>At Least One Dose: Number of residents that have had one or more doses of vaccine - 4/8/2021<td>
		<td><td>
		<td>Fully Vaccinated: Number of residents that have completed the vaccine series (this may be one or two vaccines depending on the manufacturer) - 4/8/2021<td>
	</tr>
	<tr>
		<td>Hawaii<td>
	...
	<tr>
		<td>Michigan<td>
		<td>"Initiation" is the 
percentage of Michigan 
residents who have 
received either 1 or more 
...
3/30/2021"<td>
		...
		<td>"Number of doses 
administered"" is the number of
COVID-19 vaccine doses 
reported. 3/30/2021"<td>
	</tr>
	<tr>
		<td>Minnesota<td>
...
Data is collected every day for 22 states that are reporting data on vaccine administration and overwriting that data daily. Of these 22 states, data entry is being completed on 16 of them, while the other 6 are still solely being archived. 
